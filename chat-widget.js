...
(function() {
    ...
    widgetStyles.textContent = `
        .chat-assist-widget {
            ...
            --chat-shadow-sm: 0 1px 3px rgba(0, 159, 239, 0.1);
            --chat-shadow-md: 0 4px 6px rgba(0, 159, 239, 0.15);
            --chat-shadow-lg: 0 10px 15px rgba(0, 159, 239, 0.2);
            --chat-radius-sm: 8px;
            --chat-radius-md: 12px;
            --chat-radius-lg: 20px;
    ...
    launchButton.innerHTML = `
        ...
        <span class="chat-launcher-text">Rabiš pomoč?</span>`;
